          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center  px-9 text-center translate-y-[75%] transition duration-500 group-hover:translate-y-[-10%]">
            <div className="pb-2">
              ...
              <div className="">
                <a
                  href={link}
                  className="flex-row-reverse gap-2 items-center px-1 py-1 text-xs font-medium text-center text-white bg-[#1E1E1E] rounded-lg hover:bg-[#637C65] focus:ring-4 focus:outline-none focus:ring-blue-300 inline-flex"
                >
                  اكتشف المزيد
                  <svg
